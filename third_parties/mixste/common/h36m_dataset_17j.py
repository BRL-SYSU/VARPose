...
h36m_skeleton_17j = Skeleton(parents=[-1, 0, 1, 2, 0, 4, 5, 0, 7, 8, 9, 8, 11, 12, 8, 14, 15],
...
class Human36mDataset17j(MocapDataset):
    def __init__(self, path):
        super().__init__(fps=50, skeleton=h36m_skeleton_17j)
