...
class UnchunkedGenerator_Seq:
    ...
    def __init__(self, cameras, poses_3d, poses_2d, metadata=None, pad=0, causal_shift=0,
                 augment=False, kps_left=None, kps_right=None, joints_left=None, joints_right=None):
    ...
    def next_epoch(self):
        for idx, (seq_cam, seq_3d, seq_2d) in enumerate(zip_longest(self.cameras, self.poses_3d, self.poses_2d)):
            ...
            yield meta, batch_cam, batch_3d, batch_2d
