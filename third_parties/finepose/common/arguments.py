...
def parse_args():
    ...
    parser.add_argument('--keypoints-path', default='', type=str, metavar='PATH',
                        help='custom path to 2D keypoints npz file (overrides default path)')
    parser.add_argument('--dataset-3d-path', default='', type=str, metavar='PATH',
                        help='custom path to 3D dataset npz file (overrides default path)')
    parser.add_argument('--skip-s11-directions', action='store_true',
                        help='skip S11 Directions sequences during data fetching')
    parser.add_argument('--skip-action-remap', action='store_true',
                        help='skip action name remapping for datasets with already matching names')
    ...
    parser.add_argument('-c', '--checkpoint', default='checkpoint/finetune/exp', type=str, metavar='PATH',
    ...
    parser.add_argument('--finetune', action='store_true',
                        help='enable fine-tuning with dense 2D keypoints for 17-joint 3D pose estimation')
    ...
    # Experimental
    parser.add_argument('-gpu', default='2,3,4,5,6', type=str,
