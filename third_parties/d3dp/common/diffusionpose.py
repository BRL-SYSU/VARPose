...
class D3DP(nn.Module):
    ...
    def __init__(self, args, joints_left, joints_right, is_train=True, num_proposals=1, sampling_timesteps=1, num_joints=17, num_joints_dense=144, dense_fuse_strategy='cross_attention'):
        super().__init__()
        ...
        self.num_joints_dense = num_joints_dense
        ...
        self.pose_estimator = MixSTE2(num_frame=self.frames, num_joints=num_joints, num_joints_dense=num_joints_dense, in_chans=2, embed_dim_ratio=args.cs, depth=args.dep,
        num_heads=8, mlp_ratio=2., qkv_bias=True, qk_scale=None,drop_path_rate=drop_path_rate, is_train=is_train, dense_fuse_strategy=self.dense_fuse_strategy)
