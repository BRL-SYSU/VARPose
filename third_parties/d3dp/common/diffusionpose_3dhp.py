...
class D3DP(nn.Module):
    ...
    def __init__(self, args, joints_left, joints_right, is_train=True, num_proposals=1, sampling_timesteps=1, num_joints=17, num_joints_dense=144, dense_fuse_strategy='concat'):
        super().__init__()
