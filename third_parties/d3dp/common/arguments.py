...
def parse_args():
    ...
    parser.add_argument("--dense_fuse_strategy", default='cross_attention', type=str, choices=['concat', 'cross_attention'], help='fuse strategy for dense feature')
    parser.add_argument('--finetune', default="", type=str, metavar='N', help='model need finetuning')
    ...
    parser.add_argument('-sampling_timesteps', type=int, default=1, metavar='N', help='sampling_timesteps')
