...
dataset_path = '/home/puky/puky_HPE/data/human3.6m/data_3d_h36m_remapped.npz'
...
keypoints = np.load('/home/puky/puky_HPE/data/human3.6m/data_2d_h36m_cpn_contiguous_161j.npz', allow_pickle=True)
...
def eval_data_prepare(receptive_field, inputs_2d, inputs_3d):
    ...
    assert inputs_2d.shape[:-2] == inputs_3d.shape[:-2], "2d and 3d inputs shape must be same! "+str(inputs_2d.shape)+str(inputs_3d.shape)
    ...
    with torch.no_grad():
        ...
        for cam, batch, batch_2d in test_generator.next_epoch():
            ...
            for batch_cnt in range(total_batch):
                ...
                inputs_2d_single_sparse = inputs_2d_single[..., :17, :]
                ...
                error_reproj_select = mpjpe_diffusion_reproj(predicted_3d_pos_single, inputs_3d_single, reproject_2d, inputs_2d_single_sparse) # J-Agg
                ...
                if args.p2:
                    ...
                    error_reproj_select_p2 = p_mpjpe_diffusion_reproj(predicted_3d_pos_single, inputs_3d_single, reproject_2d, inputs_2d_single_sparse)
