...
def parse_args(argv):
    ...
    parser.add_argument('--dataset', type=str, default='h36m', help='dataset name (h36m, 3dpw, etc.)')
    parser.add_argument("--dataset-path", type=str, default="data/h36m/h36m_test.pkl", help="path to dataset file")
...
def get_dataloader(subset='test',
     ...
     dataset='h36m', use_dense=False, dataset_path="data/h36m/h36m_test.pkl",
    ...
    dataset_obj = H36MDataset3D(
        ...
        detector_dataset_path = detector_dataset_path)  # [data] * rep for multi-sample-eval
    
    sampler = DistributedEvalSampler(dataset_obj,
